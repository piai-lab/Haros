...
| F-04 | Synara alignment 只有一个 adopted head，不维护 `stable + patches` 双轨 | candidate | `source-adoptions.json`; `SYNARA-INTAKE.md`; `research/source-review.md` |
...
| F-11 | 代表性 Pi Package/Extension/Skill/Prompt/Tool/MCP 可在 OmniMind Agent 中真实运行 | candidate | `PI-ECOSYSTEM-INTAKE.md`; package-specific research |
