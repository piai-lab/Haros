...
| F-03 | Synara exact baseline `02c8a6c…` 的 source、lineage、rights、selected paths 与 OmniMind differences 可追踪                                                                                                                        | source/legal audit                           | candidate | sole README adoption record 锁定 Synara `02c8a6c…`；Pi runtime adoption 锁定 `53fa77c…`、`packages/coding-agent`、npm integrity 与归档 SHA-256 `16b3ae81…ba934a9`；shared runtime bytes 对 exact 0.84.1 artifact 不变，archive closure 差异、tar/root MIT 与复现/更新门已披露；frozen SHA document contract 12/12 | `9ce368fbdc6eba34dbe6a714be2d9290db2a8839` |
...
| F-10 | Synara Workbench、Settings、File/Viewer/Diff/Terminal/Git、stream/scroll、a11y/perf 在 surgery 后无 material regression                                                                                                           | e2e/visual/a11y/profile                      | candidate | post-i18n 真实 macOS Electron：File/Viewer 保存、外部 SHA 冲突保留 dirty buffer 与磁盘内容、Diff/Git working tree、Terminal cwd/git/wc、Markdown Artifact 与 Send to Agent 全链可达；DeepSeek 80 行 stream 与 160 项 large output 后 Timeline 高 4565px，manual scroll/auto-follow、thread switch、重启恢复及 continuation 准确；恢复后 120 rAF 平均 16.60ms、最大 33.3ms、无 >34ms，AX 无匿名控件；frozen gate 为 document 12/12、typecheck 6/6 tasks、unit 8/8 tasks、Chromium stable 276/276、build 4/4 tasks；Linux geometry quarantine 在 macOS 为 3 pass/9 个平台前提失败，按既有 CI owner 留待 Linux runner | `9ce368fbdc6eba34dbe6a714be2d9290db2a8839` |
...
| F-17 | 一套 OmniMind message catalog 覆盖正常用户可达产品面；中文/英文、IME、keyboard、screen reader、reduced motion、真实 long thread/burst/large output 达到可用质量；不把 source 零散文案冒充完整 i18n                                | catalog coverage + dual-locale/a11y/profile  | candidate | 单一 typed catalog 以 compile-time/focused parity 锁定 System/简体中文/English，并接入 shell、Agent/Chat、Projects/Groups、Composer、Timeline、Workbench、Settings、Library、错误与 updater；隔离 macOS Electron 实时切换中英，native Skill 描述/provenance 保持原文；原生 IME composition 只进入 draft，Tab/Shift+Tab 往返 composer；reduced-motion 动画为 0s；AX 无匿名控件，final SHA 的 workspace picker 可见文本与 AX 名均为“选择工作项目”，关闭重开仍可达 Agent/Chat；DeepSeek 160 项大输出、manual scroll、重启恢复与 continuation 绿；catalog key parity、full unit、Chromium stable 276/276、build 绿 | `9ce368fbdc6eba34dbe6a714be2d9290db2a8839` |
