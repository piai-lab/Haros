...
| F-10 | Synara Workbench、Settings、File/Viewer/Diff/Terminal/Git、stream/scroll、a11y/perf 在 surgery 后无 material regression；OmniMind-owned 一级入口和 first-party public exits 不因 source transplant 回退 | e2e/visual/a11y/profile + bounded product-surface falsifier | candidate | `9ce368f…` 的 File/Viewer/Diff/Terminal/Git/Artifact、Send to Agent、save-conflict、IME/a11y/stream/perf 真实 journey 保留为输入；本 SHA 以当前 route 原生恢复双入口，并完成隔离 Electron 双语/隐藏态/关闭重开。sole-owner denylist 驱动的 production-source + built-surface falsifier 2/2 阻止禁用 first-party destination 泄漏，同时允许 adopted upstream/provider URL；冻结总门为 typecheck 6/6、unit 8/8、Chromium stable 280/280、build 4/4、document/public-surface 14/14 | `57b4aec02efcb4ce0b581764ef6a57c7feecf6e0` |
...
| F-17 | 一套 OmniMind message catalog 覆盖正常用户可达产品面；中文/英文、IME、keyboard、screen reader、reduced motion、真实 long thread/burst/large output 达到可用质量；不把 source 零散文案冒充完整 i18n                                | catalog coverage + dual-locale/a11y/profile  | candidate | 唯一 catalog 与 AST source falsifier 覆盖全部直达 Settings 分区、Search/shortcuts/toast、Chat header/Composer/Workbench/root error/updater，保持 raw provider output、路径、命令、模型名与技术诊断原文；隔离 macOS Electron 逐区验证 Settings 及 Chat/Workbench/Library/error/updater 的中英切换、无凭据准确阻止且无 fallback、关闭重开后 locale 持久。focused catalog/source/browser 与冻结 typecheck 6/6、unit 8/8、Chromium stable 280/280、build 4/4 均绿 | `57b4aec02efcb4ce0b581764ef6a57c7feecf6e0` |
