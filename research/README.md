...
| [`pi-web-access-intake.md`](pi-web-access-intake.md)                                                             | `@harnessos/oa-web-access` exact lineage、P1–P6、rights、更新与删除边界                                        |
| [`omnimind-ask-user-cognition.md`](omnimind-ask-user-cognition.md)                                               | canonical Ask User 产品裁决、fork decision、生命周期反证与证据                                                |
| [`pi-ask-user-intake.md`](pi-ask-user-intake.md)                                                                 | `@harnessos/oa-ask` exact baseline、P1–P7 patch inventory、反证与 revalidation trigger                         |
