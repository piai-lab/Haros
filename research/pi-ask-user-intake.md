# `@harnessos/oa-ask`：exact lineage、P1–P7 与更新反证

> 固定观察日期：2026-08-25
>
> 本文是 package-specific evidence owner，只保存 `@harnessos/oa-ask` 的 exact lineage、减法 fork 边界、P1–P7 patch inventory、作者回归、stop-loss 和 revalidation trigger。它不定义公共 Gate，不维护当前分支、安装、发布或下一动作。
...
| OmniMind fork                | `@harnessos/oa-ask@5.0.0-oa.1`                                                                                      | bundled OmniMind Agent Ask Tool；source-adopted private package |
...
current_fork_snapshot:
  package: "@harnessos/oa-ask@5.0.0-oa.1"
