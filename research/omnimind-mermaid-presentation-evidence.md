...
- 100-edge 纵向 fixture 得到超过 `4096px` 的 viewBox 仍可安全 ready；101-edge compressed fixtures 覆盖箭头、开放线、粗线、虚线、不可见边、sequence 与 class 关系拼写，均在 import/render 前被 connector policy 拒绝，证明资源 stop-loss 与几何资格可以分离；
