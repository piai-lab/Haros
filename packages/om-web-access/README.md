...
| `workflow` | `auto-summary` (generate a summary without opening the curator, default), `summary-review` (pause for interactive source review), or `none` (return raw results) |
