...
const decodeInstallInput = Schema.decodeUnknownSync(OmniMindEcosystemInstallInput);

describe("OmniMind ecosystem contracts", () => {
  ...
  it.each(["/private/skill.md", "../skill.md", "skills/../skill.md", "skills\\skill.md"])(
    ...
    (resourcePath) => {
      expect(() =>
        Schema.decodeUnknownSync(OmniMindEcosystemResourceToggleInput)({
