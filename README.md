...
当前本机安装与 macOS arm64 ad-hoc candidate 均来自 exact pushed product commit `9d3642557c0ab16faf48eeb06812b218027b4800`，DMG SHA-256 为 `3c58808a1bd71231f642156e47518d9db0cb5e74667b6d3edbb0b0a569bd3322`，ZIP SHA-256 为 `2b7ede9308b9c9ee998047af34ab350fecf6293c7055a5df91dd21b26f95b545`。同 SHA 闭合 240 个依赖身份、ZIP fresh-state smoke，以及任务专用 HOME、OmniMind home、Electron userData、Agent private home 与 Project 下的 packaged Settings/create/edit/conflict/remove/reload/busy/abort/关闭重开 journey；MiMo 与 DeepSeek 又证明 OmniMind/πAI-Lab 双语 identity、save-without-reload 的旧 Session snapshot、显式 reload 后下一请求、SYSTEM 高级路径和稳定脱敏 request digest。该 digest 不冒充 Provider cache 命中证据，任务 profile 也没有读取或改写真实用户 stock `.pi` 或其他 Engine private home。其祖先证据继续覆盖 request-level、compaction、Host loader/tool、Engine picker、Goal/Todo/Debug/宽屏/图标/Profile/Thread Group 等既有责任。该产物是本地未签名/未公证 candidate，不冒充 official release，也没有创建 GitHub Release 或修改 update feed；后续纯文档 SHA 不冒充 installed product bytes。
