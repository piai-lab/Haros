...
const script = fileURLToPath(new URL("./measure-complexity-v5.mjs", import.meta.url));
const root = fileURLToPath(new URL("../..", import.meta.url));
const baseline = "7582170a277477ba0d71cf70f53e4e0836874a72";
const acceptedDesign = "9d065923b8bd6a8d3748e1439d661ed217e36c5a";
...
describe("product-truth-complexity-v5", () => {
  it("emits byte-identical B0 JSON from strict accepted-Design authority", () => {
    ...
    expect(report).toMatchObject({ format: "product-truth-complexity-v5", commit: baseline });
  ...
  it("keeps v1-v4 instrument bytes immutable", () => {
  ...
  it.concurrent.each([
    ...
    if (fixture === "classifier-copy-positive") {
      expect(report.semanticGates.directToolClassifierCopyAuthority.derived).toMatchObject({
        status: "exact",
        flowSha256: "5834f4e535adc366ef15baca562d17653572451393b2dbef521fc1fe7541cc65",
      });
