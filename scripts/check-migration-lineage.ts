...
const migrationsFile = "apps/service/src/persistence/Migrations.ts";

/**
 * Every shipped OmniMind database records its applied migrations as (id, name)
...
const HANDLED_RELEASED_DIVERGENCES: readonly MigrationLineageAllowance[] = [
  ...
  // Renamed in place (not renumbered) during the OmniMind identity cutover, so
