...
export const DESKTOP_IPC_CHANNELS = {
  ...
  startupPresentation: "desktop:startup-presentation",
  ...
  browser: {
    vault: {
      ...
      listLogins: "desktop:browser-vault-logins",
      retryCapture: "desktop:browser-vault-retry-capture",
      cookieImportStatus: "desktop:browser-cookie-import-status",
      cancelCookieImport: "desktop:browser-cookie-cancel",
