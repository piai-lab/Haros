// This file mostly exists because we want dev mode to say "OmniMind (Dev)" instead of "electron"
...
import { resolveOmniMindDesktopFlavor, omnimindDesktopIdentity } from "@omnimind/shared/desktopIdentity";
