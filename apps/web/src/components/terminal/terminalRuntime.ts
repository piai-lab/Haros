...
const TERMINAL_PARKING_CONTAINER_ID = "omnimind-terminal-parking";
...
const TERMINAL_CURSOR_STYLE: NonNullable<OmniMindTerminalOptions["cursorStyle"]> = "bar";
const TERMINAL_INACTIVE_CURSOR_STYLE: NonNullable<OmniMindTerminalOptions["cursorInactiveStyle"]> =
  "bar";
...
function syncTheme(entry: TerminalRuntimeEntry): void {
  ...
  const terminalOptions = entry.terminal.options as OmniMindTerminalOptions;
