          ...
          >
            <CommandPanel className="overflow-hidden">
              <div className="relative">
                <CommandInput
                  ...
                  startAddon={
                    isBrowsing ? (
                      <FolderAddIcon className="text-muted-foreground" />
                    ) : (
                      <SearchIcon className="text-muted-foreground" />
                    )
                  }
                  className={isBrowsing ? (willCreateMissingFolder ? "pe-36" : "pe-24") : undefined}
                />
                {isBrowsing ? (
                  <Button
                    variant="outline"
            ...
            <CommandFooter>
              {isBrowsing ? (
                <>
                  <span>
                    {isAddingProject ? "Adding project..." : "Type a path, ↑↓ to navigate folders."}
                  </span>
                  <span>
                    {hasHighlightedFolderItem
