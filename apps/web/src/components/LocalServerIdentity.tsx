...
} from "@harnessos/shared/localServers";
 ...
 * - "browser": the in-app browser's local-servers home (larger theme-aware cards).
 */
 ...
 * — e.g. two apps both titled "HarnessOS" started from different directories.
 */
