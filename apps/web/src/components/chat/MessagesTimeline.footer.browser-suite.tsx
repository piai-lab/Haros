...
export function registerMessagesTimelineFooterBrowserTests(kind: BrowserTestKind): void {
  ...
  describe("MessagesTimeline settled assistant footer", () => {
    ...
    geometryIt.each(VIEWPORT_WIDTHS)(
      "aligns the first action glyph with message text at %ipx",
      async (widthPx) => {
