      ...
      <ComposerStackedPanelRow>
        <ComposerStackedPanelRowMain>
          ...
          <ComposerStackedPanelRowLabel className="shrink-0">
            {canPause
              ? t(paused ? "composer.goalPausedLabel" : "composer.goalPursuing")
        ...
        <div className="flex shrink-0 items-center gap-0">
          ...
          {canPause ? (
            <IconButton
              variant="ghost"
              size="icon-chip"
              label={t(paused ? "composer.goalResume" : "composer.goalPause")}
          ...
          <IconButton
            variant="ghost"
            size="icon-chip"
            label={t(open ? "composer.goalCollapse" : "composer.goalExpand")}
            aria-expanded={open}
