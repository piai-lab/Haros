// FILE: EngineUsageLineList.tsx
// Purpose: Shared engine-usage line renderer for settings cards and compact popovers.
...
type EngineUsageLineListSurface = "settings" | "popover";

const SURFACE_CLASSES: Record<
  EngineUsageLineListSurface,
  {
    item: string;
    row: string;
    label: string;
...
export function EngineUsageLineList({
  className,
  lines,
  surface,
}: {
  ...
  surface: EngineUsageLineListSurface;
}) {
