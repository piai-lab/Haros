// FILE: SpaceIcon.tsx
// Purpose: Renders built-in and custom Space icons through OmniMind's glyph asset renderer.
...
export function SpaceIcon(props: {
  ...
  return (
    <Glyph name={props.icon} label={props.label} className={cn("size-4", props.className)} />
  );
}
