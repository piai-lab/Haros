// FILE: EngineUsageSettingsPanel.browser.tsx
...
import { UsageHistorySection } from "./EngineUsageSettingsPanel";
  ...
  it("keeps a cleared index distinct from ready and offers an explicit resume", async () => {
    harness.query = {
      data: {
        ...
        engines: [
          { engine: "codex", status: "pending", progress: emptyProgress },
          { engine: "claude", status: "pending", progress: emptyProgress },
        ],
        rows: [],
      },
      isPending: false,
