...
const EN_MESSAGES = {
  ...
  "settings.builtInToolsDescription":
    "Choose which Haros built-in tools are available in Agent, Chat, and Studio.",
  "settings.portableSkills": "Portable skills",
  "settings.skillsFolder": "Haros skills folder",
  ...
  "settings.skillDiscoveryFailedDescription":
    "Haros could not scan the skill folders. Retry after checking that the server is running.",
  "settings.noSkills": "No skills found",
  "settings.noSkillsDescription":
    "Add a skill folder containing a SKILL.md to the Haros skills folder above, or install skills for any supported engine.",
  ...
  "settings.enabledSkillsSummary": "{enabled} of {total} Haros skills enabled",
  "settings.enableHarosSkill": "Enable the {skill} Haros skill",
  "settings.builtInToolsForAgents": "Agent access",
  "settings.builtInToolsForAgentsDescription":
    "These controls affect every Agent, including Haros Agent. They do not turn off the Browser or Device panels you use directly. New calls are checked immediately; tool lists update in a new session or after a supported reload.",
  ...
  "settings.builtInGroupTasksDescription":
    "Lets Agents inspect, create, coordinate, interrupt, rename, and archive Haros tasks.",
  ...
  "settings.builtInGroupGoalsDescription":
    "Lets Agents manage explicit persistent goals for Haros tasks.",
  "settings.builtInGroupAutomations": "Automations",
  "settings.builtInGroupAutomationsDescription":
    "Lets Agents create, inspect, update, stop, and report scheduled Haros automations.",
  "settings.builtInGroupBrowser": "Browser",
  "settings.builtInGroupBrowserDescription":
    "Lets Agents work with Haros's shared in-app browser when it is available.",
  ...
  "settings.builtInGroupsUnavailableDescription":
    "Haros could not load the current built-in tool status. Try again after the server reconnects.",
  "settings.builtInUpdateFailed": "Could not update built-in tools",
  "settings.builtInUpdateFailedDescription":
    "Haros restored the server's current setting. Try again.",
  "settings.builtInRefreshFailed": "Setting saved; status could not refresh",
  "settings.builtInRefreshFailedDescription":
    "Your choice is saved. Haros will refresh the current tool status after reconnecting.",
  ...
  "settings.builtInConfirmationFailedDescription":
    "Haros could not confirm whether your choice was saved. It will refresh after reconnecting.",
...
const ZH_CN_MESSAGES = {
  ...
  "settings.skillsFolder": "Haros 技能文件夹",
  "settings.skillsFolderDescription":
    "这里的技能会投影到兼容的引擎，不会复制到其私有目录；同名引擎原生资产保持独立。",
  "settings.scanning": "正在扫描…",
  "settings.skillDiscoveryFailed": "技能发现失败",
  "settings.skillDiscoveryFailedDescription":
    "Haros 无法扫描技能文件夹；请确认服务正在运行后重试。",
  "settings.noSkills": "未找到技能",
  "settings.noSkillsDescription":
    "请在上方 Haros 技能文件夹中添加包含 SKILL.md 的技能文件夹，或为受支持的引擎安装技能。",
  "settings.totalPrompts": "提示词总数",
  "settings.promptSingular": "提示词",
  "settings.promptPlural": "提示词",
  "settings.skillsExplored": "探索过的技能",
  "settings.enabledSkillsSummary": "已启用 {enabled}/{total} 个 Haros 技能",
  "settings.enableHarosSkill": "启用 Haros 技能：{skill}",
  "settings.builtInToolsForAgents": "Agent 访问权限",
  "settings.builtInToolsForAgentsDescription":
    "这些开关作用于所有 Agent，包括 Haros Agent；不会关闭你直接使用的浏览器或设备面板。新调用会立即按当前设置检查，工具列表在新会话或受支持的重新加载后更新。",
  ...
  "settings.builtInGroupsUnavailableDescription":
    "Haros 无法加载当前内置工具状态；请在服务器重新连接后重试。",
  "settings.builtInUpdateFailed": "无法更新内置工具",
  "settings.builtInUpdateFailedDescription": "Haros 已恢复服务器当前设置，请重试。",
  "settings.builtInRefreshFailed": "设置已保存，但无法刷新状态",
  "settings.builtInRefreshFailedDescription":
    "你的选择已经保存；Haros 会在重新连接后刷新当前工具状态。",
  "settings.builtInRefreshFailedInline": "你的选择已经保存，但当前工具状态暂时无法刷新。",
  "settings.builtInConfirmationFailed": "无法确认设置结果",
  "settings.builtInConfirmationFailedDescription":
    "Haros 暂时无法确认你的选择是否已保存；重新连接后会刷新服务器状态。",
  "settings.builtInConfirmationFailedInline":
    "Haros 暂时无法确认你的选择是否已保存；在服务器状态刷新前会保留当前选择。",
