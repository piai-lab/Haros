...
const EN_MESSAGES = {
  "settings.webSearchDescription":
    "Configure OmniMind Web Access routing, source review, and search services.",
  "settings.webSearch.loading": "Loading OmniMind Web Access settings…",
  ...
  "settings.webSearch.showKey": "Show key",
  "settings.webSearch.hideKey": "Hide key",
  "settings.webSearch.copyValue": "Copy value",
  "settings.webSearch.clear": "Clear",
  ...
  "settings.webSearch.capability": "OmniMind Web Access",
...
const ZH_CN_MESSAGES = {
  "settings.webSearchDescription": "配置 OmniMind 网络访问的路由、来源审查与搜索服务。",
  "settings.webSearch.loading": "正在加载 OmniMind 网络访问设置…",
  ...
  "settings.webSearch.showKey": "显示密钥",
  "settings.webSearch.hideKey": "隐藏密钥",
  "settings.webSearch.copyValue": "复制值",
  "settings.webSearch.clear": "清除",
  ...
  "settings.webSearch.capability": "OmniMind 网络访问",
  "settings.webSearch.capabilityDescription":
