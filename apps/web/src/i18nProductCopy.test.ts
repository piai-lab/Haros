...
const PRODUCT_COPY_SOURCES = [
  ...
  "onboarding/OnboardingStepFooter.tsx",
  "onboarding/steps/DoneStep.tsx",
  "onboarding/steps/EngineConnectTerminal.tsx",
  "onboarding/steps/EnginesStep.tsx",
  "onboarding/steps/FeatureTourStep.tsx",
  "onboarding/steps/ProjectStep.tsx",
  "onboarding/steps/ThemeStep.tsx",
  "onboarding/steps/WelcomeStep.tsx",
  "onboarding/tourContent.ts",
  ...
  "components/BrowserVault.tsx",
  "components/BrowserVaultMaster.tsx",
  "components/BrowserCookieImport.tsx",
  "components/SafariAccessOnboarding.tsx",
  ...
  "components/DiffPanelCompareRefMenuSection.tsx",
  ...
  "components/DiffLineBlamePopover.tsx",
  "components/DiffTruncationWarning.tsx",
  ...
  "components/chat/useAppSnapWindows.ts",
  "appSnapIntake.ts",
  ...
  "components/chat/ComposerEffortSliderCard.tsx",
  "lib/remarkWikiLinks.ts",
  ...
  "components/chat/AsyncUserInputCard.tsx",
  ...
  "components/chat/TranscriptSelectionActionLayer.tsx",
  "components/chat/SelectionNewChatComposer.tsx",
  "lib/selectionChat.ts",
  ...
  "hooks/useWorkspaceFileEditor.ts",
  "lib/workspaceEditorSession.ts",
...
const RAW_FACT_ALLOWLIST = [
  ...
  "SidebarActivityView.tsx:text:Haros",
...
describe("reachable Haros-owned product copy", () => {
  ...
  it("keeps normal Prompt settings copy in Haros product language", () => {
    const forbidden = [
      /\bPi\b/u,
      /Pi-compatible/iu,
      /ResourceLoader/u,
