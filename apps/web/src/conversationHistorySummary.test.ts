import { EventId, MessageId, TurnId } from "@omnimind/contracts";
import type {
...
describe("deriveConversationSummaryMetadata", () => {
  it("derives sidebar summary metadata from thread state", () => {
    ...
    const proposedPlans: ConversationHistoryPlan[] = [
      {
        id: "plan-1",
        turnId: TurnId.makeUnsafe("turn-2"),
    ...
    const latestTurn: ConversationHistoryRun = {
      turnId: TurnId.makeUnsafe("turn-2"),
      state: "completed",
