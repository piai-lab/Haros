...
export const SETTINGS_SEARCH_ENTRIES: readonly SettingsSearchEntry[] = [
  ...
  {
    id: "prompts:global-personal-instructions",
    section: "prompts",
    title: "Global personal instructions",
    keywords: "OmniMind Agent prompt instructions AGENTS global context file",
    target: SETTINGS_TARGETS.globalPersonalInstructions,
  },
  {
    id: "prompts:advanced",
    section: "prompts",
...
const SETTINGS_SEARCH_TITLE_KEY_BY_TITLE: Readonly<Record<string, MessageKey>> = {
  ...
  "Global personal instructions": "settings.globalPersonalInstructions",
  "Advanced prompt files": "settings.advancedPromptFiles",
