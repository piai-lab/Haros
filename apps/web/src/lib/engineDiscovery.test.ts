// FILE: engineDiscovery.test.ts
// Purpose: Verifies engine discovery search normalization and ranking behavior.
// Layer: Web lib tests
...
function makeSkill(partial: Partial<EngineSkillDescriptor>): EngineSkillDescriptor {
  return {
    name: "example-skill",
