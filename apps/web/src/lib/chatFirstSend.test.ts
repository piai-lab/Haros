...
describe("resolveFirstSendTarget", () => {
  it("creates a managed date/slug chat project for a plain general chat first send", () => {
    ...
    expect(result).toMatchObject({
      kind: "create-project",
      creation: {
        workspaceRoot: "/Users/tester/Documents/Haros/2026-06-11/yes-it-takes-all-the-skills",
        title: "Yes it takes",
        kind: "chat",
  ...
  it("ignores a stale workspace selection and still creates a managed Chat", () => {
    ...
    expect(result).toMatchObject({
      kind: "create-project",
      creation: {
        workspaceRoot: "/Users/tester/Documents/Haros/2026-06-11/use-app",
        title: "Use app",
        kind: "chat",
        createWorkspaceRootIfMissing: true,
        defaultEngineSelection,
  ...
  it("keeps a plain Studio first send in the Studio container", () => {
    ...
    expect(result).toMatchObject({
      ...
      target: {
        ...
        targetProjectCwd: "/Users/tester/Documents/Haros/Studio",
      },
    });
  });
