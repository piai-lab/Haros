...
const ICON_KEYWORDS: ReadonlyArray<readonly [SpaceIconName, ReadonlyArray<string>]> = [
  ["code-brackets", ["code", "dev", "engineer", "software", "开发", "代码", "编程"]],
  ["bag", ["work", "job", "office", "business", "client", "工作", "业务", "客户"]],
  ["school", ["school", "study", "learn", "course", "exam", "学校", "学习", "课程", "考试"]],
  ...
  ["color-palette", ["design", "art", "brand", "creative", "设计", "艺术", "品牌"]],
  ["book", ["book", "read", "writ", "note", "doc", "书", "阅读", "写作", "文档"]],
  ["lab", ["lab", "research", "experiment", "science", "实验", "研究", "科学"]],
  ["heart", ["health", "love", "fitness", "wellness", "健康", "健身"]],
  ["star", ["favorite", "favourite", "important", "priorit", "收藏", "重要", "优先"]],
  ["globe", ["travel", "world", "international", "旅行", "世界", "国际"]],
  ["cloud", ["cloud", "infra", "devops", "server", "云", "基础设施", "服务器"]],
  ["hammer", ["build", "tool", "maker", "hardware", "diy", "工具", "硬件", "制作"]],
  ["chart-2", ["financ", "money", "invest", "analytic", "data", "财务", "投资", "数据"]],
