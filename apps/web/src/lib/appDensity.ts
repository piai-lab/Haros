...
const BASE_ROW_PADDING_Y_REM = 0.1875;
...
const BASE_COMPOSER_EDITOR_PADDING_BOTTOM_REM = 0.625;
const BASE_COMPOSER_EDITOR_PADDING_X_REM = 0.875;
const BASE_COMPOSER_EDITOR_PADDING_X_END_REM = 1;
const BASE_COMPOSER_FOOTER_PADDING_REM = 0.5;
