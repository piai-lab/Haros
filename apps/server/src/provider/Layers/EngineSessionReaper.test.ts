...
import { makeProviderSessionReaperLive } from "./EngineSessionReaper";
...
function makeLayer(input: {
  ...
  return makeProviderSessionReaperLive({
    ...
    Layer.provide(Layer.succeed(EngineService, input.providerService)),
    Layer.provide(
      Layer.succeed(
...
describe("EngineSessionReaperLive", () => {
  it("stops stale sessions without active turns", async () => {
    ...
    const providerService: EngineServiceShape = {
