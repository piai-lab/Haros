...
const makeProviderSessionReaper = (options?: EngineSessionReaperLiveOptions) =>
  Effect.gen(function* () {
...
export const makeProviderSessionReaperLive = (options?: EngineSessionReaperLiveOptions) =>
  Layer.effect(EngineSessionReaper, makeProviderSessionReaper(options));

export const EngineSessionReaperLive = makeProviderSessionReaperLive();
