...
/**
 * OmniMind owns the approval step after the planning turn settles. Returning a
...
/** OmniMind has already received an implementation turn, so Grok may leave its native gate. */
