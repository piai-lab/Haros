...
import { OAModelServices } from "../Services/OAModelServices.ts";
import { EngineService, type EngineServiceShape } from "../Services/EngineService.ts";
import { makeOAModelServicesLive } from "./OAModelServices.ts";
...
async function loadService(input: {
  ...
  return Effect.runPromise(
    Effect.gen(function* () {
      const service = yield* OAModelServices;
...
function makeTestLayer(input: {
  ...
  return makeOAModelServicesLive({
