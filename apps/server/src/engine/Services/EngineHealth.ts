...
export interface EngineHealthShape {
   ...
   */
  readonly getStatuses: Effect.Effect<ReadonlyArray<ServerEngineStatus>>;

  /**
   * Force a foreground refresh of engine health snapshots.
   */
  readonly refresh: Effect.Effect<ReadonlyArray<ServerEngineStatus>>;
   ...
   */
  readonly getPassivePresence: Effect.Effect<ReadonlyArray<ServerEngineStatus["engine"]>>;
   ...
   */
  readonly streamChanges: Stream.Stream<ReadonlyArray<ServerEngineStatus>>;
}

export class EngineHealth extends ServiceMap.Service<EngineHealth, EngineHealthShape>()(
  "harnessos/engine/Services/EngineHealth",
) {}
