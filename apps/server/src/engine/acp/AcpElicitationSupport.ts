...
// Purpose: Bridges ACP form elicitation schemas to Haros's engine-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by Haros's composer.
