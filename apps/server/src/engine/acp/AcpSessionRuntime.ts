...
export interface AcpSessionRuntimeOptions {
   ...
   * `mcpCapabilities` (e.g. HTTP vs stdio for the Haros HostGateway).
   */
...
/**
 * Bridges Effect's child-process exit signal into Haros's process-tree proof. This is deliberately
...
>()("harnessos/engine/acp/AcpSessionRuntime") {
  static layer(
