...
describe("makeEngineLifecycleCoordinator", () => {
  it("publishes the run generation for the duration of a committed run", async () => {
    await Effect.runPromise(
      Effect.gen(function* () {
        const coordinator = makeEngineLifecycleCoordinator();
