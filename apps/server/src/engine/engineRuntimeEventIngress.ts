...
export interface SizedEngineRuntimeEvent {
  readonly event: EngineRuntimeEvent;
  readonly bytes: number;
}

export function isTerminalEngineRuntimeEvent(event: EngineRuntimeEvent): boolean {
 ...
 */
export function compactEngineRuntimeEventForIngress(
