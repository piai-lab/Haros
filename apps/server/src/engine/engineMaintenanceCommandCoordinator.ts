...
export interface EngineMaintenanceCommandCoordinatorShape<E> {
...
export const makeEngineMaintenanceCommandCoordinator = Effect.fn(
  "makeEngineMaintenanceCommandCoordinator",
  ...
  const acquireTarget = Effect.fn("acquireEngineMaintenanceTarget")(function* (targetKey: string) {
  ...
  const getLock = Effect.fn("getEngineMaintenanceCommandLock")(function* (lockKey: string) {
  ...
  const withCommandLock: EngineMaintenanceCommandCoordinatorShape<E>["withCommandLock"] = ({
    targetKey,
    lockKey,
    onQueued,
    run,
  ...
  return {
    withCommandLock,
  } satisfies EngineMaintenanceCommandCoordinatorShape<E>;
});
