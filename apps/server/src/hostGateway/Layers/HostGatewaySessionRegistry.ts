...
import {
  ...
  type HostGatewaySessionIdentity,
  type HostGatewaySessionRegistryShape,
  type HostGatewayTurnAuthority,
} from "../Services/HostGatewaySessionRegistry.ts";
...
export function makeHostGatewaySessionRegistry(options?: {
  readonly now?: () => number;
  ...
  interface RegisteredSession {
    readonly identity: HostGatewaySessionIdentity;
  ...
  return {
    issue: (threadId, engine) => {
      ...
      const identity: HostGatewaySessionIdentity = {
        sessionKey,
        threadId,
        engine,
        issuedAt,
    ...
    bindTurnAuthority: (token, turnId) => {
      ...
      return {
        ...
        turnId,
      } satisfies HostGatewayTurnAuthority;
    },
...
export const HostGatewaySessionRegistryLive = Layer.sync(
  HostGatewaySessionRegistry,
  makeHostGatewaySessionRegistry,
);
