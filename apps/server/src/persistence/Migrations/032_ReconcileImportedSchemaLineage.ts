 ...
 * names. Because the migrator skips by ID, HarnessOS migrations 17-31 never run
 ...
 * HarnessOS migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh HarnessOS installs (every column already
