 ...
 * names. Because the migrator skips by ID, OmniMind migrations 17-31 never run
 ...
 * OmniMind migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh OmniMind installs (every column already
