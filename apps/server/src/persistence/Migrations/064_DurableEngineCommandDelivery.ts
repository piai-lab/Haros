...
import { ENGINE_COMMAND_REACTOR_CONSUMER } from "../Services/OrchestrationEventDeliveries.ts";

// Activates durable engine-command delivery at the exact event-log high-water
// mark. Older events were handled by the former live-only reactor and must not
// be replayed into engines. Private builds that created these tables under
