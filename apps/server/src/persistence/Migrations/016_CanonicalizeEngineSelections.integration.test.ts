...
layer("016_CanonicalizeEngineSelections", (it) => {
  it.effect(
          ...
          assert.deepStrictEqual(projectRows, [
            {
              ...
              defaultEngineSelection: '{"engine":"claude","model":"claude-opus-4-6"}',
            },
            {
              projectId: "project-codex",
              defaultEngineSelection: '{"engine":"codex","model":"gpt-5.4"}',
            },
            { projectId: "project-null", defaultEngineSelection: null },
          ]);
      ...
      `;
          assert.deepStrictEqual(threadRows, [
            ...
            },
            {
              ...
              engineSelection: '{"engine":"claude","model":"gpt-5.4"}',
            },
          ]);
