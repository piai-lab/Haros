...
const AutomationDefinitionDbRow = Schema.Struct({
  ...
  engineOptions: Schema.NullOr(Schema.fromJsonString(EngineStartOptions)),
...
function toDefinition(row: AutomationDefinitionDbRow) {
  return decodeDefinition({
    ...
    engineOptions: row.engineOptions ?? undefined,
...
const makeAutomationRepository = Effect.gen(function* () {
    ...
    execute: ({ id }) =>
      sql`
        SELECT
          ...
          provider_options_json AS "engineOptions",
      ...
      sql`
        ...
        SET project_id = ${definition.projectId},
            ...
            next_run_at = CASE
              ...
              ELSE NULL
            END,
            model_selection_json = ${definition.engineSelection},
            model_presentation_identity_json = ${definition.modelPresentationIdentity},
            provider_options_json = ${definition.engineOptions},
    ...
    execute: ({ now, limit }) =>
      sql`
        SELECT
          ...
          definitions.model_selection_json AS "engineSelection",
          definitions.model_presentation_identity_json AS "modelPresentationIdentity",
          definitions.provider_options_json AS "engineOptions",
  ...
  const createDefinition: AutomationRepositoryShape["createDefinition"] = (request) => {
    ...
    return insertDefinition({
      ...
      engineOptions: definition.engineOptions ?? null,
    ...
    return runDefinitionMutation({
      ...
      mutation: updateDefinitionRow({
        definition: {
          ...
          engineOptions: input.definition.engineOptions ?? null,
