 ...
 * through a temp b-tree for every page, making projector bootstrap quadratic in
 * the event-log size. Keeping the integer-primary-key range scan makes replay
 * linear in the covered sequence interval and preserves sequence order without
 * an extra sort.
 */
