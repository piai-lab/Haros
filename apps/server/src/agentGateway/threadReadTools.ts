...
export function makeThreadReadTools(input: ThreadReadToolsInput): ReadonlyArray<ToolEntry> {
  ...
  const listProjects: ToolEntry = {
    ...
    definition: {
      ...
      inputSchema: { type: "object", properties: {}, additionalProperties: false },
      annotations: { title: "List OmniMind projects", ...READ_ONLY_TOOL_ANNOTATIONS },
    },
    handler: () =>
  ...
  const listThreads: ToolEntry = {
    ...
    definition: {
      ...
      annotations: { title: "List OmniMind threads", ...READ_ONLY_TOOL_ANNOTATIONS },
    },
  ...
  const readThread: ToolEntry = {
    ...
    definition: {
      ...
      annotations: { title: "Read a OmniMind thread", ...READ_ONLY_TOOL_ANNOTATIONS },
    },
    handler: (args, context) =>
      Effect.gen(function* () {
  ...
  const waitForThreads: ToolEntry = {
    ...
    definition: {
      ...
      annotations: {
        title: "Wait for OmniMind threads",
        readOnlyHint: true,
        destructiveHint: false,
        idempotentHint: true,
        openWorldHint: false,
