/**
 * Stdio-to-HTTP proxy script for the HarnessOS agent gateway.
 *
...
const STDIO_PROXY_SCRIPT = `// HarnessOS agent gateway stdio<->HTTP MCP proxy (generated file, do not edit).
