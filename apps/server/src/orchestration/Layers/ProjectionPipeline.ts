import { ApprovalRequestId, CommandId, type OrchestrationEvent } from "@omnimind/contracts";
import {
  addPinnedMessage,
  removePinnedMessage,
...
import { isStalePendingRequestFailureDetail } from "@omnimind/shared/threadSummary";
