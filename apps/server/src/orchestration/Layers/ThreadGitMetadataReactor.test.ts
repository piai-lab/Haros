...
const pullRequest: OrchestrationThreadPullRequest = {
  ...
  url: "https://github.com/Emanuele-web04/omnimind/pull/574",
  baseBranch: "main",
    ...
    const harness = await createHarness({
      threads: [
        ...
        },
        {
          ...
          branch: "omnimind/worktree-stale",
          lastKnownPr: null,
        },
      ],
      branchByCwd: {
    ...
    const harness = await createHarness({
      threads: [
        ...
        },
        {
          ...
          branch: "omnimind/stale-sentinel",
          lastKnownPr: null,
        },
      ],
      branchByCwd: {
