...
// Purpose: Normalizes provider-native transcript snapshots into OmniMind import messages.
...
import { MessageId, type ThreadHandoffImportedMessage, type ThreadId } from "@harnessos/contracts";
