...
import { CommandId, ProjectId, SpaceId, type OrchestrationCommand } from "@omnimind/contracts";
...
describe("Spaces", () => {
  ...
  it("rejects filing a legacy Home chat container into a space", async () => {
    ...
    const workspacePaths = {
      homeDir: "/Users/dev",
      chatWorkspaceRoot: "/Users/dev/Documents/OmniMind/Chats",
    };
    let readModel = createEmptyReadModel(createdAt);
    ...
    ({ readModel } = await dispatch(readModel, {
      ...
      title: "OmniMind",
      workspaceRoot: "/Users/dev/code/omnimind",
      createdAt,
    }));
