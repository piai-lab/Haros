...
describe("staticCacheControl", () => {
  it("tiers hashed assets, icon sets, and revalidating files", () => {
    ...
    expect(staticCacheControl("icons/line/file.svg")).toBe(STATIC_ICON_CACHE_CONTROL);
    expect(staticCacheControl("icons/fill/file.svg")).toBe(STATIC_ICON_CACHE_CONTROL);
