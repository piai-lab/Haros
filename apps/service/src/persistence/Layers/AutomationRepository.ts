...
const AutomationDefinitionDbRow = Schema.Struct({
  ...
  requestedSelection: Schema.fromJsonString(ProductRequestedSelection),
    ...
    execute: ({ id }) =>
      sql`
        SELECT
          ...
          requested_selection_json AS "requestedSelection",
    ...
    execute: (definition) =>
      sql`
        ...
        SET project_id = ${definition.projectId},
            ...
            requested_selection_json = ${definition.requestedSelection},
    ...
    execute: ({ now, limit }) =>
      sql`
        SELECT
          ...
          definitions.requested_selection_json AS "requestedSelection",
