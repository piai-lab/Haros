...
function readAuditMetadata(tool: string, args: Record<string, unknown>) {
  ...
  return {
    ...
    environment: stringOrNull("environment") ?? (tool === "omnimind_create_task" ? "worktree" : null),
  };
}
...
export const makeExternalMcpGateway = Effect.gen(function* () {
  ...
  const capabilitiesTool: ExternalTool = {
    ...
    definition: {
      ...
      annotations: { title: "OmniMind integration capabilities", ...READ_ONLY_TOOL_ANNOTATIONS },
    },
  ...
  const createTaskTool: ExternalTool = {
    ...
    definition: {
      ...
      annotations: {
        title: "Create one OmniMind task",
        readOnlyHint: false,
  ...
  const readTaskTool: ExternalTool = {
    ...
    definition: {
      ...
      annotations: { title: "Read a permitted OmniMind task", ...READ_ONLY_TOOL_ANNOTATIONS },
    },
    handler: (args, context) =>
      Effect.gen(function* () {
  ...
  const waitTaskTool: ExternalTool = {
    ...
    definition: {
      ...
      annotations: { title: "Wait for a permitted OmniMind task", ...READ_ONLY_TOOL_ANNOTATIONS },
    },
    handler: (args, context) =>
      Effect.gen(function* () {
