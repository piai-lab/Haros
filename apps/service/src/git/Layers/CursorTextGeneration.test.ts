      ...
      (agentPath) =>
        Effect.gen(function* () {
          ...
          const generated = yield* textGeneration.generateCommitMessage({
            ...
            stagedSummary: "M apps/service/src/git/Layers/CursorTextGeneration.ts",
            stagedPatch:
              "diff --git a/apps/service/src/git/Layers/CursorTextGeneration.ts b/apps/service/src/git/Layers/CursorTextGeneration.ts",
            modelSelection: {
              provider: "cursor",
              model: "gpt-5.4",
              options: {
