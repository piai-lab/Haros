...
- 下一动作只剩：push exact source closure；用MiMo/DeepSeek完成真实schema/回答/replan；从同一pushed SHA clean-clone构建DMG并完成fresh隔离packaged全链。任一门失败都停止production claim，不降级canonical合同。
