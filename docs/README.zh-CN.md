...
| Chat   | 无需准备项目的专注对话   | HarnessOS 管理的工作区 |
...
- **默认使用 OA。** 新环境只有一个清晰起点。
- **Engine 边界真实。** Engine 管理原生 Session 和私有配置；HarnessOS 管理产品对话、
  队列、恢复和展示。
...
HarnessOS 使用 [Apache License 2.0](../LICENSE)。第三方代码与资产保留各自许可证及必要
