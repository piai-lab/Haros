...
|  17 | **Notes and Pinned Messages**                     | Turn a long transcript into durable working memory and review checkpoints.         | Notes and pin contracts and limits; UI examples. Transcript markers retired. |
