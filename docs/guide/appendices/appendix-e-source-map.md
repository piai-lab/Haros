...
|       7 | First-Run Setup                                                | `packages/shared/src/engineMetadata.ts`                               | `apps/server/src/engine/executionCapabilityProjection.test.ts`                        | First-run onboarding is removed; Settings/Composer plus capability projection own current readiness.                                      |
