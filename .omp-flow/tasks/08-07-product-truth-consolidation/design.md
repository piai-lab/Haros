...
The following is the sole Design-owned verification-path table. It is not a path category: each
row grants only the exact UTF-8 Git path bytes to the named Work for the stated lifecycle. Purpose
is explanatory and cannot be used to infer another test, fixture, extension, root, probe, support
or output path. Present rows may change only their blob while preserving presence and mode. An
absent row may first materialize only in its named `firstMaterializationWork`, at exactly its
`firstMaterializationMode`; a later named Work may modify it only after its accepted immediate
predecessor proves that materialization remains present in the same mode. Deletion, move, mode
change, resurrection outside the named lifecycle and every unlisted Git path remain rejected.

```omp-flow-product-verification-paths-v1
{
  "authority": "omp-flow-product-verification-paths-v1",
  "approvedCommit": "f110fb66006768074ca192bb94024632d16c09dd",
  "recordSchema": ["work", "path", "approvedPresence", "approvedMode", "approvedGitBlob", "approvedSha256", "allowedLifecycle", "firstMaterializationMode", "firstMaterializationWork", "purpose"],
  "verificationPathRows": [
    {"work":"direct-first-public-b1","path":"apps/service/src/config.permissions.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"50f19d6e8cd5342aeed79715c85b3bf5588527c4","approvedSha256":"e6027f04b1c9022e69f9273b7a394cf7f1e6c878e3594c93a42bdcc1408123ab","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"direct-first-public-b1","path":"apps/service/src/native-host/executionBoundary.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"c31b792db3ab9ba66ecf11c71f25f73f070c5559","approvedSha256":"391515d3a33ac6845ef8ed0d15e554f7f878b98c9a660769ec1effd6d677ac7b","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"direct-first-public-b1","path":"apps/service/src/opencode/liveJourneyProbe.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"caeb792841b8c9c88432a454ca60b4b53afc713a","approvedSha256":"0821cf71f06552a5b991e2df0f6bf9a10255e9722ad4991320ac90165e088d20","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-probe-test"},
    {"work":"direct-first-public-b1","path":"apps/service/src/persistence/Layers/Sqlite.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"088f556517e213ef791b30432613d9a18212414d","approvedSha256":"07202c81a94753f5967dace4913d37afc341a7e9fafdcff34b9ca19f532310aa","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"direct-first-public-b1","path":"apps/service/src/product/ProductControlPlane.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"dabb5b14a7b4200eec471d3f1aa3c1dbb0db8dee","approvedSha256":"051d382869dcccca0ee0475ecdcd9b4d7212f570bd4126cc5f6750aec780608a","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"direct-first-public-b1","path":"apps/web/src/appSettings.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"30c1ec0a2570cdaa59983cac9a140d64e3478eae","approvedSha256":"20280995810e90e0dfe03bd01b8e2e5563f9a7c9a68ad20aeac614e827e32fd8","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"direct-first-public-b1","path":"apps/web/src/bootstrap.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"9c065d2ad16d50c12233beaa28f46898731b3bd9","approvedSha256":"4fd21dd7f639e15fac059033c1ad2136528e66e94f5b51e2ce4ad602278cb142","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"direct-first-public-b1","path":"apps/web/src/components/chat/ComposerImageAttachmentChip.test.tsx","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"889d2da9f2f52d4a3a6722e3dd685d66a901a4fe","approvedSha256":"e5b238770548dd48fdc2eab5d3f9d0450b3be60c2f57a2b69410e49dab3646c6","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"direct-first-public-b1","path":"apps/web/src/composerDraftStore.attachments.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"f12344dd10e40f96e65c79d7dc27a30a6be1e204","approvedSha256":"cbd120df324ff79ec14d6a4827932eeda2bccbc400a42566290d38d3f8d5d15f","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"direct-first-public-b1","path":"apps/web/src/composerDraftStore.persistence.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"e90ecb47fae68b8f6426a4224f9b0e64f748c106","approvedSha256":"71bab3ecce7b742a02e65c4a7c55133c355542492b66796f8553149820b58d01","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"direct-first-public-b1","path":"apps/web/src/lib/composerImageSource.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"1dd06094275e3c9b7255d6aeeffbdc5bde657f34","approvedSha256":"2c82cb5d67118fa253bc54f12152e7671aaa9d8fd155ca4a664da63ce878d4dc","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"direct-first-public-b1","path":"scripts/product-truth/direct-first-public.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"f5da68b0f0e1d62ed31597a499d9ed30e5cb2f17","approvedSha256":"e4489f430d2301e55da2c8454a5e12a7a8c90d7ebc7dc347bc18a24fe563f30a","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test-and-generated-home-fixture-definitions"},
    {"work":"direct-first-public-b1","path":"scripts/product-truth/first-public-capability-verifier.test.ts","approvedPresence":"absent","approvedMode":null,"approvedGitBlob":null,"approvedSha256":null,"allowedLifecycle":"first-materialize-then-modify-preserve-presence-and-mode","firstMaterializationMode":"100644","firstMaterializationWork":
liveJourneyProbe.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"caeb792841b8c9c88432a454ca60b4b53afc713a","approvedSha256":"0821cf71f06552a5b991e2df0f6bf9a10255e9722ad4991320ac90165e088d20","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-probe-test"},
    {"work":"product-state-store","path":"apps/service/src/opencode/liveJourneyProbe.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"07bd5bfb28d1ec9e689577230ef1b1844ae3a755","approvedSha256":"973a632c33e17a98c0cbbc930411a5072c1b79fe2aef7686e571fd271f839674","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"integration-probe-source"},
    {"work":"product-state-store","path":"apps/service/src/product/ProductControlPlane.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"dabb5b14a7b4200eec471d3f1aa3c1dbb0db8dee","approvedSha256":"051d382869dcccca0ee0475ecdcd9b4d7212f570bd4126cc5f6750aec780608a","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"product-state-store","path":"apps/service/src/product/productStateStore.test.ts","approvedPresence":"absent","approvedMode":null,"approvedGitBlob":null,"approvedSha256":null,"allowedLifecycle":"first-materialize-then-modify-preserve-presence-and-mode","firstMaterializationMode":"100644","firstMaterializationWork":"product-state-store","purpose":"focused-test"},
    {"work":"product-state-store","path":"apps/service/src/product/testSupport/productStateFixture.ts","approvedPresence":"absent","approvedMode":null,"approvedGitBlob":null,"approvedSha256":null,"allowedLifecycle":"first-materialize-then-modify-preserve-presence-and-mode","firstMaterializationMode":"100644","firstMaterializationWork":"product-state-store","purpose":"test-support"},
    {"work":"product-execution-coordinator-facade","path":"apps/desktop/src/process/nativeHostProcess.integration.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"a1a1bcc9db80134e57b3e2aa7fc3078dca615635","approvedSha256":"31cfde7876c191c8d32f47cd1e0e15b2169a8229e59325a32be36e1d7a9d789a","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"process-integration-test"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/http.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"72a9e3f5024588a236dedd265cf3adeeb02461b1","approvedSha256":"a5f62358f362e44eaabd47d4e545065bcdbb812c52e7ab808dde4e30dc9155a5","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-readiness-test"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/main.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"fdd4aaf9531f235e335fd2d064b7c397fa9d3ed7","approvedSha256":"2cac0c5dac02665350b7abb1e371dbd6ee336cd0e6d30cfdc5cf2954b3d55a30","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/native-host/liveJourneyProbe.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"aa5ca557e73528bfb5502901932db91e7cedf9a2","approvedSha256":"b8470f8b24bf65d28daa36c77d249986308122be7767f3d53d7d125b638022e9","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-probe-test"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/native-host/liveJourneyProbe.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"d0673913be8ce1a4c7336722692f42f4e5de059a","approvedSha256":"3df7ec458a0cbaa870a5e4c9927238744190a6943da5085b4084c1f83dbb7728","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"integration-probe-source"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/native-host/packageCrashProbe.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"d6b29b421ea753257b3a2e0ba38b5104c0658477","approvedSha256":"6db042163e396a3a72dd7154635ede7b5876082d0ba4097912751cdb2fc83431","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"process-probe-source"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/native-host/serviceProcess.integration.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"ced49c57e5a47c40f6c9ac5372196aab3d28891a","approvedSha256":"bbfe0bc2794b6f7ab7bd38e21c9def50d049f17ab78242b19ff867a38718bc67","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"process-integration-test"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/opencode/liveJourneyProbe.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"caeb792841b8c9c88432a454ca60b4b53afc713a","approvedSha256":"0821cf71f06552a5b991e2df0f6bf9a10255e9722ad4991320ac90165e088d20","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-probe-test"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/opencode/liveJourneyProbe.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"07bd5bfb28d1ec9e689577230ef1b1844ae3a755","approvedSha256":"973a632c33e17a98c0cbbc930411a5072c1b79fe2aef7686e571fd271f839674","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"integration-probe-source"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/product/ProductControlPlane.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"dabb5b14a7b4200eec471d3f1aa3c1dbb0db8dee","approvedSha256":"051d382869dcccca0ee0475ecdcd9b4d7212f570bd4126cc5f6750aec780608a","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-test"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/product/engineJourneyProof.test.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"5077e26eaa89dff8d1b38b81999a6b269cf1fd5c","approvedSha256":"cae9ab60da5368d4260155d32b724ed2a1c022fa47b2cf6b366687f83c84b251","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"focused-proof-test"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/product/engineJourneyProof.ts","approvedPresence":"present","approvedMode":"100644","approvedGitBlob":"e41ae2f3bbf61cf4ffbaec069b475047c09d9c4a","approvedSha256":"e5bb292168cd17749f5c19965b97b7a51353ecba1eb0598da9be632d1bf7da3d","allowedLifecycle":"modify-blob-preserve-presence-and-mode","firstMaterializationMode":null,"firstMaterializationWork":null,"purpose":"live-journey-proof-source"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/product/productExecutionCoordinator.test.ts","approvedPresence":"absent","approvedMode":null,"approvedGitBlob":null,"approvedSha256":null,"allowedLifecycle":"first-materialize-then-modify-preserve-presence-and-mode","firstMaterializationMode":"100644","firstMaterializationWork":"product-execution-coordinator-facade","purpose":"focused-test"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/product/productStateStore.test.ts","approvedPresence":"absent","approvedMode":null,"approvedGitBlob":null,"approvedSha256":null,"allowedLifecycle":"modify-after-required-prior-materialization-preserve-presence-and-mode","firstMaterializationMode":"100644","firstMaterializationWork":"product-state-store","purpose":"focused-test"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/product/testSupport/productExecutionFixture.ts","approvedPresence":"absent","approvedMode":null,"approvedGitBlob":null,"approvedSha256":null,"allowedLifecycle":"modify-after-required-prior-materialization-preserve-presence-and-mode","firstMaterializationMode":"100644","firstMaterializationWork":"product-execution-leaf","purpose":"test-support"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/product/testSupport/productStateFixture.ts","approvedPresence":"absent","approvedMode":null,"approvedGitBlob":null,"approvedSha256":null,"allowedLifecycle":"modify-after-required-prior-materialization-preserve-presence-and-mode","firstMaterializationMode":"100644","firstMaterializationWork":"product-state-store","purpose":"test-support"},
    {"work":"product-execution-coordinator-facade","path":"apps/service/src/wsRpc.product.test.ts","approvedPresence":"absent","approvedMode":null,"approvedGitBlob":null,"approvedSha256":null,"allowedLifecycle":"first-materialize-then-modify-preserve-presence-and-mode","firstMaterializationMode":"100644","firstMaterializationWork":"product-execution-coordinator-facade","purpose":"focused-facade-contract-test"}
  ],
  "verificationPathRowsJcsAlgorithm": "JCS-encode each complete verificationPathRows row, sort those bytes by unsigned raw UTF-8, JCS-encode the resulting row array, then SHA-256",
  "verificationPathRowsJcsSha256": "c291688e134e1ea91b0905c2b8709634ecd0e5fc1cf616a0b5a656e0d6978326"
}
```

The table has 70 per-Work rows: 16 for `direct-first-public-b1`, 17 for
`native-host-package-root-binding`, 10 for `product-execution-leaf`, 10 for
`product-state-store` and 17 for `product-execution-coordinator-facade`. They name 45 unique
verification Git paths. The row digest JCS-encodes every complete row, sorts those row bytes by
unsigned raw UTF-8, JCS-encodes the resulting array and hashes it with SHA-256; it is not the block's
authored display order. Unioning those exact paths with the unchanged 69-member production
universe yields 110 unique approved-state records: 88 present and 22 absent. Each complete
`{path,presence,mode,gitBlob,sha256}` record is derived from approved commit
`f110fb66006768074ca192bb94024632d16c09dd`, JCS-encoded, sorted by unsigned raw UTF-8 record
bytes and JCS-encoded as one array; its SHA-256 is
`2d189676ed940fa9299504a7e0fc47aa91f5c7eced44c115be21340d83df3ac9`.
The original production-only 69-row state and five production fence bytes remain separately
unchanged. Runtime-generated temporary homes/profiles and external reviewer output are not Git
paths, receive no row and create no exemption.
...
as reject. The only mutable set is the selected Work's exact `production` members plus the exact
rows for that Work in `omp-flow-product-verification-paths-v1`. `measurement` and `dependency`
entries, test/fixture naming, extensions, root predicates, handoffs, Reviews, reports and current
outputs grant nothing. A selected authorized row present at the approved tree may change only its
blob and preserves presence/mode. An absent production path remains absent except for four exact
`100644` production materializations: `productExecutionBoundary.ts`, `productStateStore.ts`,
`productExecutionCoordinator.ts` and `productStateDiagnostics.ts` in their Interface-named Works.
An absent verification row follows only its table-named first Work/mode; later Work modification is
allowed only after a required prior materialization remains present at the same mode. Exactly nine
unique verification paths first materialize this way. There are no path deletions or moves.
...
Every non-selected record stays exact; an overlapping selected production or exact verification
path follows only its row lifecycle above. Candidate paths absent from the approved record set are
still covered by the independent all-Git-path default reject. This binds the Pi todo source and manifest, adopted patch,
...
the four exact production lifecycle materializations or is already present. The candidate literal graph is
...
config integrity, all-Git-path default rejection, the unchanged 69-row production state, the exact
70-row verification authority and complete 110-row boundary-plus-verification lifecycle state,
...
8. every Git changed path passes the default-reject/exact-selected-production-or-verification-row
   rule; the unchanged 69-row production state, 70 verification rows, complete 110-row lifecycle
   authority and 6,321-row dependency/adoption byte expansion reproduce; exact external
...
- V9 structural fixtures cover only the complete `--no-renames` Git changed-path set, default
  rejection, exact selected-production or selected-Work verification-row membership, the unchanged
  69-row production state/four production materializations, the 70-row verification table/nine
  verification materializations, complete 110-row lifecycle state, official evidence tuple/blob/
  ancestry, outside presence/mode/blob/SHA-256, the
...
official evidence, all-Git-path default rejection, exact selected-production and verification-row
lifecycles, exact outside
